...
<footer class="footer mt-5 py-3 bg-dark text-light">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <h5>GameStore Hakkında</h5>
                <p>GameStore, oyunseverlerin buluşma noktası. En yeni ve popüler oyunları keşfedin.</p>
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <p class="mb-0">&copy; <?php echo date('Y'); ?> GameStore. Tüm hakları saklıdır.</p>
            </div>
        </div>
    </div>
</footer>
